...
interface MemoCardContentFormProps {
  memo: Memo;
}
export default function MemoCardContentForm({
  memo,
}: Readonly<MemoCardContentFormProps>) {
      ...
      <div className="flex-between">
        <div className="flex items-center gap-4px text-gray-600">
          ...
          <p className="text-14px text-gray-600">
            ...
            {getDayByAsiaSeoulFormat(new Date(memo.createdAt))})
          </p>
        </div>
        <button
          onClick={handleOpen}
