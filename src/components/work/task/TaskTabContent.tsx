    ...
    >
      <div className="min-h-screen bg-gray-50 p-16px">
        <div className="grid grid-cols-4 gap-8px">
          <Droppable droppableId={Progress.ToDo}>
            {(provided) => (
              <div
          ...
          <Droppable droppableId={Progress.InProgress}>
            {(provided) => (
              <div
                className="flex flex-col gap-16px"
                {...provided.droppableProps}
          ...
          <Droppable droppableId={Progress.Review}>
            {(provided) => (
              <div
                className="flex flex-col gap-16px"
                {...provided.droppableProps}
          ...
          <Droppable droppableId={Progress.Completed}>
            {(provided) => (
              <div
                className="flex flex-col gap-16px"
                {...provided.droppableProps}
